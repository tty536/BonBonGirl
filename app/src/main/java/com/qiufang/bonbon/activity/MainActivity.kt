...
//import com.qiufang.bonbon.ActivityMainBinding
import com.qiufang.bonbon.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        super.onResume()
        LogUtil.d(TAG,"Activity Resume...")
    }

    override fun onStop() {
        super.onStop()
        LogUtil.d(TAG,"Activity Stop...")
    }
